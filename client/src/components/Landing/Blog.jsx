...
const blogs = [
  {
    ...
    date: "June 1, 2025",
    excerpt:
      "When time is critical, Bleed for a Cause delivers. Read how a young thalassemia patient received life-saving blood within 30 minutes, thanks to our smart donor-matching system that leverages geolocation, real-time notifications, and AI-backed prioritization.",
  },
  {
  ...
  {
    title: "Behind the Scenes: How Bleed for a Cause Works",
    date: "May 10, 2025",
    excerpt:
      "Have you ever wondered what powers our life-saving tech? Dive into the architecture of Bleed for a Cause – from AI models analyzing blood demand patterns to real-time mobile alerts that connect donors to recipients in under a minute.",
  },
  {
  ...
  },
  {
    ...
    date: "March 20, 2025",
    excerpt:
      "From blockchain-backed donor tracking to AI-matched blood needs, technology is revolutionizing the way we donate and receive blood. Here's how platforms like Bleed for a Cause are leading the charge in tech-driven health solutions.",
  },
  {
    title: "Emergency Response: How Bleed for a Cause Helped During a City-wide Crisis",
    date: "March 5, 2025",
    excerpt:
      "During the recent metro train accident, blood demand skyrocketed. Discover how Bleed for a Cause coordinated with donors and hospitals to deliver over 300 units in 4 hours — a testament to what community and technology can achieve together.",
  },
];
